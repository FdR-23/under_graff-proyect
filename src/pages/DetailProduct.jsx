  ...
  if (!Boolean(product)) {
    ...
    return (
      <div className='max-w-screen-xl w-full  mx-auto'>
        ...
        <div className='bg-violet-950/75 min-w-[800px] rounded box-border mt-10'>
                  ...
                  <div className='text-[#000000e6] inline-block  font-light mt-4 ' >
                    ...
                    <div className='flex justify-start items-center translate-x-[-1px] '>
                      <span className='text-[#000000e6] text-[36px] font-normal leading-[1] inline-flex items-baseline  '>
                        <span className='text-[36px] mt-1 self-start ml-[1px]'>{product?.precio && priceFormater(product?.precio)}</span>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className='mt-4 w-full flex flex-row flex-wrap'>
                  <div className='text-[#000000e6]'>
                    <div className='flex items-center  w-full relative top-[-1px] dropdown '>
                      ...
                      <span className='text-[#0000008c] text-[11px]  ml-[6px] overflow-hidden text-ellipsis  w-auto'>
                  ...
                  <div className="w-full my-2">
                    ...
                    <div className=" w-full flex flex-row justify-between my-2 ml-1">
                      <div className=" w-9 h-8 p-2 px-3 rounded-md   flex items-center justify-center border-2 
                                hover:border-[#820e55] hover:shadow-sm hover:shadow-[#820e55]  hover:font-semibold">
                        <p>{product.talla}</p>
                      </div>
                    </div>
                    <div >
                  ...
                  <div className='w-full box-border'>
                    <div >
                      ...
                      <form onSubmit={SubmitAddCart}>
                        <button disabled={product.stock <= 0 ? true : false} className={`disabled:opacity-75  w-full mt-[8px] bg-[#820e565e] border-transparent text-[#820e55] 
                          rounded-md inline-block text-[16px] font-bold h-12 px-6 text-center `}>
