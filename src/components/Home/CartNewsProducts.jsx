...
import { TYPE } from '../../Reducer/actions.js';
    ...
    return (
        <div
           ...
           relative  overflow-hidden'>
            ...
            <div className={`${!product?.image ? `hidden` : ` border-2 border-black h-full relative `}`}>
                ...
                transition-all ease-in-out duration-500`}>
                    <p className={` text-lg text-white tracking-tighter skew-x-6 -rotate-2 leading-4 absolute left-1 top-2`}>{product?.name}</p>
